...
const navItems = [
  ...
  { section: 'Sitio Web' },
  { label: 'Banner principal', path: '/contenido/banner-principal', icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="m3 15 5-5 4 4 3-3 6 6"/></svg> },
